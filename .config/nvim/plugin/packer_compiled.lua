...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  ["dashboard-nvim"] = {
    ...
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
    url = "https://github.com/glepnir/dashboard-nvim"
  },
  dracula = {
    config = { "\27LJ\2\n4\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\25user.plugins.dracula\frequire\0" },
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/dracula",
  ...
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim",
  ...
  ["nvim-code-action-menu"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/nvim-code-action-menu",
    url = "https://github.com/weilbith/nvim-code-action-menu"
  },
  ["nvim-lint"] = {
    config = { "\27LJ\2\n6\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\27user.plugins.nvim-lint\frequire\0" },
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/nvim-lint",
  ...
  ["nvim-treesitter-textobjects"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textobjects",
    url = "https://github.com/nvim-treesitter/nvim-treesitter-textobjects"
  },
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  phpactor = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/dani/.local/share/nvim/site/pack/packer/opt/phpactor",
    url = "https://github.com/phpactor/phpactor"
  },
  playground = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["schemastore.nvim"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/schemastore.nvim",
    url = "https://github.com/b0o/schemastore.nvim"
  },
  ["spellsitter.nvim"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/spellsitter.nvim",
    url = "https://github.com/lewis6991/spellsitter.nvim"
  },
  tagbar = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  ["telescope-live-grep-raw.nvim"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/telescope-live-grep-raw.nvim",
  ...
  ["vim-floaterm"] = {
    ...
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/vim-floaterm",
  ...
  ["vim-fugitive"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/dani/.local/share/nvim/site/pack/packer/opt/vim-fugitive",
    url = "https://github.com/tpope/vim-fugitive"
  },
  ["vim-rhubarb"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/vim-rhubarb",
    url = "https://github.com/tpope/vim-rhubarb"
  },
  ["vim-sayonara"] = {
    config = { "\27LJ\2\n5\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\26user.plugins.sayonara\frequire\0" },
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/vim-sayonara",
